...
import { BlockStatement, Declaration, ExpressionStatement, Statement, TSType, TSTypeParameterDeclaration, addComment } from "@babel/types"
...
export interface InterfaceCallSignature {
  docs?: string
