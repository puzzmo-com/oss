import type { MutationResolvers, QueryResolvers, SeasonResolvers } from "types/graphql"
...
export const updateSeason: MutationResolvers["updateSeason"] = ({ id, input }) => {
...
export const Season: SeasonResolvers = {
  ...
  Prediction: (_obj, { root }) => db.season.findUnique({ where: { id: root.id } }).Prediction(),
}
