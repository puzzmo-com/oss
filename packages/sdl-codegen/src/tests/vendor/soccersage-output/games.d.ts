...
import type { Game as RTGame, Prediction as RTPrediction, Season as RTSeason, Team as RTTeam } from "./shared-return-types"
...
export interface GameTypeResolvers<Extended> {
  ...
  predictions: (
    args: undefined,
    obj: { root: GameAsParent<Extended>; context: RedwoodGraphQLContext; info: GraphQLResolveInfo },
