...
import type { Game as PGame, Prediction as PPrediction, Team as PTeam } from "@prisma/client"
import type { RedwoodGraphQLContext } from "@redwoodjs/graphql-server/dist/functions/types"

import type { Game as RTGame, Prediction as RTPrediction, Team as RTTeam } from "./shared-return-types"
...
export interface TeamsResolver {
  ...
  ): RTTeam[] | Promise<RTTeam[]> | (() => Promise<RTTeam[]>)
}
...
export interface UpdateTeamResolver {
  (
    args: { id: number; input: UpdateTeamInput },
    obj?: { root: object; context: RedwoodGraphQLContext; info: GraphQLResolveInfo },
  ): RTTeam | Promise<RTTeam> | (() => Promise<RTTeam>)
}
...
export interface TeamTypeResolvers {
  ...
  id: (
    args: undefined,
    obj: { root: TeamAsParent; context: RedwoodGraphQLContext; info: GraphQLResolveInfo },
  ...
  homeTeamGames: (
    args: undefined,
    obj: { root: TeamAsParent; context: RedwoodGraphQLContext; info: GraphQLResolveInfo },
  ) => Array<RTGame> | Promise<Array<RTGame>> | (() => Promise<Array<RTGame>>)
