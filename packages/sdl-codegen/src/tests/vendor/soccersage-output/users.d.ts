...
import type { Prediction as RTPrediction, SuccessInput as RTSuccessInput, User as RTUser } from "./shared-return-types"
...
export interface UsersResolver {
  ...
  ): RTUser[] | Promise<RTUser[]> | (() => Promise<RTUser[]>)
}
...
export interface UserTypeResolvers {
  ...
  id: (
    args: undefined,
    obj: { root: UserAsParent; context: RedwoodGraphQLContext; info: GraphQLResolveInfo },
  ...
  resetTokenExpiresAt: (
    args: undefined,
    obj: { root: UserAsParent; context: RedwoodGraphQLContext; info: GraphQLResolveInfo },
  ) => DateTime | null | Promise<DateTime | null> | (() => Promise<DateTime | null>)
