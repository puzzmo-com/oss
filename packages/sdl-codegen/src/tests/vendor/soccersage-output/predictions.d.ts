...
import type { Game as PGame, Prediction as PPrediction, Team as PTeam, User as PUser } from "@prisma/client"
import type { RedwoodGraphQLContext } from "@redwoodjs/graphql-server/dist/functions/types"

import type {
  Game as RTGame,
  Prediction as RTPrediction,
  StandingsResult as RTStandingsResult,
  Team as RTTeam,
  User as RTUser,
...
export interface StandingsResolver {
  ...
  ): Promise<RTStandingsResult | null>
}
...
export interface PredictionsResolver {
  (
    args?: object,
    obj?: { root: object; context: RedwoodGraphQLContext; info: GraphQLResolveInfo },
  ): RTPrediction[] | Promise<RTPrediction[]> | (() => Promise<RTPrediction[]>)
}
...
export interface PredictionResolver {
  (
    args: { id: number },
    obj?: { root: object; context: RedwoodGraphQLContext; info: GraphQLResolveInfo },
  ): RTPrediction | null | Promise<RTPrediction | null> | (() => Promise<RTPrediction | null>)
}

/** SDL: createPrediction(input: CreatePredictionInput!): Prediction! */
export interface CreatePredictionResolver {
  (
    args: { input: CreatePredictionInput },
    obj?: { root: object; context: RedwoodGraphQLContext; info: GraphQLResolveInfo },
  ): RTPrediction | Promise<RTPrediction> | (() => Promise<RTPrediction>)
}
...
export interface UpdatePredictionResolver {
  (
    args: { id: number; input: UpdatePredictionInput },
    obj?: { root: object; context: RedwoodGraphQLContext; info: GraphQLResolveInfo },
  ): RTPrediction | Promise<RTPrediction> | (() => Promise<RTPrediction>)
}
...
export interface PredictionTypeResolvers {
  ...
  id: (
    args: undefined,
    obj: { root: PredictionAsParent; context: RedwoodGraphQLContext; info: GraphQLResolveInfo },
  ...
  teamId: (
    args: undefined,
    obj: { root: PredictionAsParent; context: RedwoodGraphQLContext; info: GraphQLResolveInfo },
  ) => number | null | Promise<number | null> | (() => Promise<number | null>)
  ...
  user: (
    args: undefined,
    obj: { root: PredictionAsParent; context: RedwoodGraphQLContext; info: GraphQLResolveInfo },
  ) => RTUser | null | Promise<RTUser | null> | (() => Promise<RTUser | null>)

  /** SDL: team: Team */
  team: (
    args: undefined,
    obj: { root: PredictionAsParent; context: RedwoodGraphQLContext; info: GraphQLResolveInfo },
  ) => RTTeam | null | Promise<RTTeam | null> | (() => Promise<RTTeam | null>)
